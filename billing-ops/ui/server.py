#!/usr/bin/env python3
"""Personal control panel for the billing-ops RailCall module.
...
with STRIPE_SECRET_KEY, TWILIO_ACCOUNT_SID, and TWILIO_AUTH_TOKEN all set
in ITS environment -- this module touches both providers.
"""
import json
import os
...
def main():
    print(f"billing-ops control panel -> http://127.0.0.1:{PORT}")
